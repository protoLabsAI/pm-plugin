...
### Input
Your task is to segment users for **the product or feature in focus** based on behavior, jobs-to-be-done, and unmet needs.
...
- How this segment uses the product or feature in focus (primary use cases, frequency, depth)
...
**Current Product Fit**
- How well the product or feature in focus currently serves this segment
