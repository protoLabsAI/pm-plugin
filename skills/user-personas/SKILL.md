...
### Input
Your task is to create 3 refined user personas for **the product or feature in focus**.
...
- How the product or feature in focus addresses (or could address) this persona's needs
